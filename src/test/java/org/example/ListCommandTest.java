...
public class ListCommandTest {
    ...
    public void testExecutePrintsInJsonFormatWhenOptionIsProvided() {
        ...
        CommandParser parser = new CommandParser();
        SubCommand command = parser.parse(new String[]{"--url", "http://test.com", "list", "--format", "JSON"});
        ...
        assertTrue(output.contains("\"name\": \"Clavier\""), "Output should contain JSON formatted product name");
    }
}